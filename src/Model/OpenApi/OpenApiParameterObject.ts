 ...
 *
 * @source https://github.com/OAI/OpenAPI-Specification/blob/master/versions/3.0.3.md#parameterObject
 */
export interface OpenApiParameterObject {
	 ...
	 */
	examples: {[value: string]: OpenApiExampleObject|OpenApiReferenceObject};
	 ...
	 */
	content: {[value: string]: OpenApiExampleObject|OpenApiReferenceObject};
